...
Tanto a estratégia de _momentum_, quanto `\(1/N\)`, "batem" o índice dentro do período selecionado. Como quase sempre, o portfolio `\(1/N\)` é difícil de ser superado por uma larga margem.
